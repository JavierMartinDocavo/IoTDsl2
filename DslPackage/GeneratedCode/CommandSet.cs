...
namespace Compañía.IotDsl
{
	...
	/// </summary>
	internal partial class IotDslCommandSet : IotDslCommandSetBase
	{
		/// <summary>
		/// Constructs a new IotDslCommandSet.
		/// </summary>
		public IotDslCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class IotDslCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new IotDslCommandSetBase.
		/// </summary>
		protected IotDslCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewIotDslExplorerCommand,
				typeof(IotDslEditorFactory).GUID);
		...
		{
			IotDslExplorerToolWindow explorer = this.IotDslExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected IotDslDocData CurrentIotDslDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as IotDslDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected IotDslDocView CurrentIotDslDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as IotDslDocView;
			}
		}
		...
		/// </summary>
		protected IotDslExplorerToolWindow IotDslExplorerToolWindow
		{
			get
			{
				IotDslExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(IotDslExplorerToolWindow), true) as IotDslExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				IotDslExplorerToolWindow explorerWindow = this.IotDslExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class IotDslClipboardCommandSet : IotDslClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new IotDslClipboardCommandSet.
		/// </summary>
		public IotDslClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class IotDslClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new IotDslClipboardCommandSetBase.
		/// </summary>
		protected IotDslClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
