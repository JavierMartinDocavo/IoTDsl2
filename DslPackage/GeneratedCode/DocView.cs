...
namespace Compañía.IotDsl
{
	...
	/// </summary>
	internal partial class IotDslDocView : IotDslDocViewBase
	{
		/// <summary>
		/// Constructs a new IotDslDocView.
		/// </summary>
		public IotDslDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class IotDslDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new IotDslDocView.
		/// </summary>
		protected IotDslDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			IotDslDocDataBase docData = this.DocData as IotDslDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for IotDslDocViewBase should be an IotDslDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Compañía.IotDsl.IotDslDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Compañía.IotDsl.IotDslDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Compañía.IotDsl.IotDslToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Compañía.IotDsl.IotDslToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.IotDslDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Compañía.IotDsl.IotDslHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Compañía.IotDsl.IotDslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Compañía.IotDsl.IotDslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
