...
namespace Compañía.IotDsl
{
	...
	/// </summary>
	internal partial class IotDslExplorer : IotDslExplorerBase
	{
		/// <summary>
		/// Constructs a new IotDslExplorer.
		/// </summary>
		public IotDslExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the IotDslExplorerToolWindow.
	/// </summary>
	internal abstract class IotDslExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new IotDslExplorerBase.
		/// </summary>
		protected IotDslExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.IotDslExplorerMenu;
			}
		}
