...
namespace Compañía.IotDsl
{
	...
	[VSShell::ProvideStaticToolboxItem("Compañía.IotDsl.CloudToolboxTab",
					...
					Index = 7)]
	[VSShell::ProvideStaticToolboxItem("Compañía.IotDsl.CloudToolboxTab",
					"@ServiceBusToolToolboxItem;Compañía.IotDsl.Dsl.dll", 
					"Compañía.IotDsl.ServiceBusToolToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"MessageService", 
	...
	[VSShell::ProvideStaticToolboxItem("Compañía.IotDsl.CloudToolboxTab",
					...
					Index = 11)]
	[VSShell::ProvideStaticToolboxItem("Compañía.IotDsl.CloudToolboxTab",
					"@LineGraphToolToolboxItem;Compañía.IotDsl.Dsl.dll", 
					"Compañía.IotDsl.LineGraphToolToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"LineGraphTool", 
					"@LineGraphToolToolboxBitmap;Compañía.IotDsl.Dsl.dll", 
					0xff00ff,
					Index = 12)]
	[VSShell::ProvideStaticToolboxItem("Compañía.IotDsl.CloudToolboxTab",
					"@DataAnalyticsInputConnectionToolToolboxItem;Compañía.IotDsl.Dsl.dll", 
					"Compañía.IotDsl.DataAnalyticsInputConnectionToolToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"DataAnalyticsConnectionInput", 
					"@DataAnalyticsInputConnectionToolToolboxBitmap;Compañía.IotDsl.Dsl.dll", 
					0xff00ff,
					Index = 13)]
	[VSShell::ProvideStaticToolboxItem("Compañía.IotDsl.CloudToolboxTab",
					"@DataAnalyticsOutputConnectionToolboxItem;Compañía.IotDsl.Dsl.dll", 
					"Compañía.IotDsl.DataAnalyticsOutputConnectionToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"DataAnalyticsOutputConnection", 
					"@DataAnalyticsOutputConnectionToolboxBitmap;Compañía.IotDsl.Dsl.dll", 
					0xff00ff,
					Index = 14)]
	...
	[VSShell::ProvideStaticToolboxItem("Compañía.IotDsl.DeviceToolboxTab",
					...
					"Compañía.IotDsl.RaspberryPiToolToolboxItem", 
					"CF_TOOLBOXITEMCONTAINER,CF_TOOLBOXITEMCONTAINER_HASH,CF_TOOLBOXITEMCONTAINER_CONTENTS", 
					"RaspberryPiTool", 
