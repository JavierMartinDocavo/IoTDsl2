...
namespace Compañía.IotDsl
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.IotDslEditorFactoryId)]
	internal partial class IotDslEditorFactory : IotDslEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new IotDslEditorFactory.
		/// </summary>
		public IotDslEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class IotDslEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected IotDslEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new IotDslDocData(this.ServiceProvider, typeof(IotDslEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new IotDslDocView(docData, this.ServiceProvider);
		}
	}
}
