...
namespace Compañía.IotDsl
{
	...
	/// </remarks>
	public partial class IotDslHelpKeywordHelper : IotDslHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new IotDslHelpKeywordHelper.
		/// </summary>
		protected IotDslHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the IotDslHelpKeywordHelper.
		/// </summary>
		public static IotDslHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class IotDslHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new IotDslHelpKeywordHelperBase.
		/// </summary>
		protected IotDslHelpKeywordHelperBase()
			: base() { }
